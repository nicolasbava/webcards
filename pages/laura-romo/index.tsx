...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/laura-romo/config-data';
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/laura-romo/config-data';
