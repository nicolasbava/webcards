...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/coro-familia-dominguez/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/coro-familia-dominguez/config-data'; //CAMBIAR DIRECCION
import { PlinthColor } from '../../components/template1/plinth/plinthcolor';
import { CoverPageTextBox } from '../../components/template1/coverpage/coverpagetextbox';
