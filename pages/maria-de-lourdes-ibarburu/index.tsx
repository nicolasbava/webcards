...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/maria-de-lourdes-ibarburu/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/maria-de-lourdes-ibarburu/config-data'; //CAMBIAR DIRECCION
