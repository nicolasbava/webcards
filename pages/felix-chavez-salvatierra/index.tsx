...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/felix-chavez-salvatierra/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/felix-chavez-salvatierra/config-data'; //CAMBIAR DIRECCION
    ...
    <div>
      ...
      >
        ...
        <InformationColorProfile
          ...
          btnName={'Catálogo de Productos Wijex'}
