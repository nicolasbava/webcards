...
import { CoverPageWhite } from '../../components/template0/coverpage/coverpagewhite';
import { CoverPage} from '../../components/template0/coverpage/coverpage';
import { CoverPageDownLeft } from '../../components/template0/coverpage/coverpagedownleft';
...
import { InformationNoButton } from '../../components/template0/information/informationnobutton';

/* import data */
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/yaneisi-pedraza-garcia/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/yaneisi-pedraza-garcia/config-data'; //CAMBIAR DIRECCION
