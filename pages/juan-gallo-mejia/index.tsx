...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/juan-gallo-mejia/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/juan-gallo-mejia/config-data'; //CAMBIAR DIRECCION
