...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/mary-pily-urena/config-data';
import { InformationProfileTextBtn } from '../../components/template4/information/informationtextbtn';
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/mary-pily-urena/config-data';
