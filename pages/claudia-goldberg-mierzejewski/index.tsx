...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/claudia-goldberg-mierzejewski/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/claudia-goldberg-mierzejewski/config-data'; //CAMBIAR DIRECCION
  ...
  return (
    <div>
      ...
      <Layout
        ...
        url={'claudia-goldberg-mierzejewski'}
      >
        <CoverPage
          name={PERSONAL_DATA.NAME}
          description={PERSONAL_DATA.DESCRIPTION}
