...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/rebeca-segundo/config-data';
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/rebeca-segundo/config-data';
