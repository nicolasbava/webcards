...
import LayoutBlue from '../../components/template1/layout/layoutblue';
...
import { PlinthTitleBlue } from '../../components/template1/plinthtitle/plinthtitleblue';
import { InformationProfileEdit } from '../../components/template1/information/informationedit';
import { PlinthTitleTwoBlue } from '../../components/template1/plinthtitletwo/plinthtitletwoblue';
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/mario-rodes-clemente/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/mario-rodes-clemente/config-data'; //CAMBIAR DIRECCION
...
const ProfilePage: NextPage = () => {
  return (
    <div>
      ...
      <LayoutBlue name={PERSONAL_DATA.NAME}
