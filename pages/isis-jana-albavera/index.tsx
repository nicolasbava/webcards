...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/isis-jana-albavera/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/isis-jana-albavera/config-data'; //CAMBIAR DIRECCION
  ...
  return (
    <div>
      ...
      <Layout
        ...
        url={'isis-jana-albavera'}
      >
        <CoverPageBlue       //cambiar el nombre del cover para alguna modificacion especifica
          name={PERSONAL_DATA.NAME}
          description={PERSONAL_DATA.DESCRIPTION}
        ...
        <InformationProfile
          ...
          btnName={'PRODUCTOS WIJEX'} //cambiar nombre de catologo y revisar ortografia
        />
        <PlinthTitle
          title={'Galería'}
        />
