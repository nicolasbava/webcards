...
import { InformationProfileBlue } from '../../components/template0/information/informationblue';
import { PlinthTitleTwoBlue } from '../../components/template0/plinthtitletwo/plinthtitletwoblue';
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/gabriela-balsa/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/gabriela-balsa/config-data'; //CAMBIAR DIRECCION
