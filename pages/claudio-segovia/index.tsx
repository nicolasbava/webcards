...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/claudio-segovia/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/claudio-segovia/config-data'; //CAMBIAR DIRECCION
import { CoverPageBlue } from '../../components/template0/coverpage/coverpageblue';
