...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/gustavo-vargas-palenque/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/gustavo-vargas-palenque/config-data'; //CAMBIAR DIRECCION
    ...
    <div>
      ...
      >
        ...
        <InformationColorProfile
          ...
          btnName={'Catálogo Productos Wijex'}
