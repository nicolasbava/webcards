...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/cainco-chuquisaca/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/cainco-chuquisaca/config-data'; //CAMBIAR DIRECCION
    ...
    <div>
      ...
      >
        ...
        <InformationColorProfile
          ...
          btnName={'BENEFICIOS PARA AFILIADOS'}
