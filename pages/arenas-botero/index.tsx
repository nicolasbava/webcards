...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/arenas-botero/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/arenas-botero/config-data'; //CAMBIAR DIRECCION
    ...
    <div>
      ...
      >
        <CoverPageTextButton
          ...
          btnName={'Portafolio de servicios'}
        />
        <SocialMedia
          name={PERSONAL_DATA.NAME}
