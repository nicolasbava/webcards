...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/andres-vasquez-rios/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/andres-vasquez-rios/config-data'; //CAMBIAR DIRECCION
    ...
    <div>
      ...
      >
        ...
        <ContactProfile
          ...
          country={CONTACT_DATA.COUNTRY}
          avatar={IMAGE_DATA.AVATAR}
          url={'andres-vasquez-rios'} //CAMBIAR NOMBRE CARPETA
        />
        <PlinthTitleBlue
