...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/luz-castaneda-gonzalez/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/luz-castaneda-gonzalez/config-data'; //CAMBIAR DIRECCION
