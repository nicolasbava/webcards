...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/jorge-aristizabal-gutierrez/config-data';
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/jorge-aristizabal-gutierrez/config-data';
import { ContactProfileNotBtn } from '../../components/template3/contact/contactnotbtn';
  ...
  return (
    <div>
      ...
      <Layout
        ...
        url={'jorge-aristizabal-gutierrez'}
      >
        <CoverPageTwo
          name={PERSONAL_DATA.NAME}
          description={PERSONAL_DATA.DESCRIPTION}
