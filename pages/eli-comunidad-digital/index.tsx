...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/eli-comunidad-digital/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/eli-comunidad-digital/config-data'; //CAMBIAR DIRECCION
    ...
    <div>
      ...
      >
        <CoverPageTextButton
          ...
          btnName={'Curriculum Éli Comunidad Digital'}
        />
        <SocialMedia
          name={PERSONAL_DATA.NAME}
