...
import { CoverPageBlue } from '../../components/template2/coverpage/coverpageblue';
import { SocialMediaBlue } from '../../components/template2/socialmedia/socialmediablue';
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/william-navarro-gonzalez/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/william-navarro-gonzalez/config-data'; //CAMBIAR DIRECCION
import LayoutBlue from '../../components/template2/layout/layoutBlue';
    ...
    <div>
      ...
      >
        <CoverPageBlue
          ...
          btnName={'Libro la Magia de Pensar en Grande'}
        />
        <SocialMediaBlue
          name={PERSONAL_DATA.NAME}
