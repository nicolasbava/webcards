...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/alvaro-gallo-ospina/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/alvaro-gallo-ospina/config-data'; //CAMBIAR DIRECCION
