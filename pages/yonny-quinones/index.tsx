...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/yonny-quinones/config-data';
import { InformationProfileTextBtn } from '../../components/template4/information/informationtextbtn';
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/yonny-quinones/config-data';
