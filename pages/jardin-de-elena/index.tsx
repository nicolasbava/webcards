...
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/jardin-de-elena/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/jardin-de-elena/config-data'; //CAMBIAR DIRECCION
    ...
    <div>
      ...
      >
        ...
        <InformationProfile
          ...
          btnName={'CATALOGO'} //cambiar nombre de catologo y revisar ortografia
        />
        <PlinthTitle
          title={'Galería'}
        />
