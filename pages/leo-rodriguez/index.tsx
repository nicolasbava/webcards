...
import { CoverPageCopy } from '../../components/template2/coverpage/coverpagecopy';
import { CONTACT_DATA, CURRICULUM_DATA } from '../../profile-data/leo-rodriguez/config-data'; //CAMBIAR DIRECCION
import { IMAGE_DATA, PERSONAL_DATA, SOCIALNET_DATA } from '../../profile-data/leo-rodriguez/config-data'; //CAMBIAR DIRECCION
