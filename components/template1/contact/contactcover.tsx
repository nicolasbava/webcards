...
// HI THERE
// THIS IS THE SAME COMPONENT AS CONTACT BUT THE DIFFERENCE IS:
// IMAGE IS COVER SIZE
// If you need cover size use this component
// If you need contain image size use "contact" component
...
const ContactProfileCover = (props: ContactProps) => {
            ...
            <div className="sm:flex sm:flex-row sm:ml-10  mx-0 justify-center md:mb-8">
                ...
                <div className="lg:flex flex-col self-center sm:max-w-5xl xl:max-w-2xl z-10">
                    <div className="mx-auto flex items-center justify-center flex-col">
                        {/* == THIS IMAGE I AM TALKING - COVER SIZE == */}
                        <img
