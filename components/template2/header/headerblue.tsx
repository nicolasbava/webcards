...
export default function HeaderNavBlue(props: Props) {
                                ...
                                >
                                    <div className='flex flex-row items-center'>
                                        <img
                                            ...
                                            src={`${router.basePath}/assert/icons/download-t2-blue.png`}
                                            width={16}
                                            alt="logo-linkedin"
                                        />
                                        <div className='flex flex-col ml-2'>
                                            <text
                                                className="text-sm font-semibold leading-none title-font  text-t2secondary  text-left"
                                            >
                                                Descargar
                                            </text>
                                            <text
                                                className="text-sm font-semibold leading-none  title-font  text-t2secondary text-left mt-0.5"
                                            >
                                                Contacto
                                            </text>
                                        </div>
